...
var createRecordOfflinePlayer = function (record, _a) {
    ...
    var playMessage = function (message, onPlay) {
        ...
        for (var _i = 0, _b = message.items || []; _i < _b.length; _i++) {
            var item = _b[_i];
            if (item.command) {
                var command = assistant.__assign({}, item.command);
    ...
    var playNext = function (onPlay) {
        ...
        while ((entry.type !== 'incoming' ||
            ...
            entry.message.name !== assistant.MessageNames.ANSWER_TO_USER ||
        ...
        return currentRecord.entries.some(function (e, i) {
            ...
            return i >= entryCursor &&
                ...
                e.message.name === assistant.MessageNames.ANSWER_TO_USER &&
...
(function (module, exports) {
	...
	var freeGlobal = typeof assistant.commonjsGlobal == 'object' && assistant.commonjsGlobal && assistant.commonjsGlobal.Object === Object && assistant.commonjsGlobal;
...
var cloneDeep = /*@__PURE__*/assistant.getDefaultExportFromCjs(lodash_clonedeepExports);

var getDefaultRecord = function () { return ({
    midToRequestKey: {},
    requestKeyToMessages: {},
}); };
var getMid = function (message) { return String(message.messageId); };
...
var serializeMessage = function (message) {
    if (message.systemMessage) {
        message.systemMessage = assistant.protoExports.SystemMessage.create({
            data: JSON.stringify(message.systemMessage.data),
        });
    }
    return message;
};
var createAnswerFromMockByMessageGetter = function (record) { return function (message) {
    ...
    return messagesFromMock.map(function (messageFromMock) { return serializeMessage(cloneDeep(messageFromMock)); });
}; };
var createMockRecorder = function (defaultActive) {
    if (defaultActive === void 0) { defaultActive = true; }
    var _a = assistant.createBaseRecorder(defaultActive, getDefaultRecord), prepareHandler = _a.prepareHandler, start = _a.start, stop = _a.stop, baseGetRecord = _a.getRecord, updateRecord = _a.updateRecord;
    var getRecord = function () {
        ...
        var requestKeyToMessages = Object.keys(baseRecord.requestKeyToMessages)
            .sort()
...
var createMockWSCreator = function (recordMock, timeout) {
    ...
    return function (url) {
        ...
        var _a = assistant.createNanoEvents(), on = _a.on, emit = _a.emit;
        var send = function (dataToSend) {
            ...
            var messageToSend = assistant.protoExports.Message.decode(new Uint8Array(dataToSend).slice(4));
            ...
            responseMessageList.forEach(function (responseMessageFromMock) {
                ...
                var buffer = assistant.protoExports.Message.encode(responseMessageFromMock).finish();
                var data = assistant.appendHeader(buffer);
                // setTimeout для того, чтобы ответить не в этом стэке js'а
                // для того чтобы поведение было приближено к реальному
                setTimeout(function () { return emit('message', { data: data }); }, timeout);
            });
        };
        setTimeout(function () { return emit('open'); });
...
exports.MessageNames = assistant.MessageNames;
Object.defineProperty(exports, 'VpsVersion', {
    enumerable: true,
    get: function () { return assistant.VpsVersion; }
});
exports.createAssistant = assistant.createAssistant$1;
exports.createAssistantClient = assistant.createAssistant;
exports.createAssistantSDK = assistant.createAssistant;
exports.createNavigatorAudioProvider = assistant.createNavigatorAudioProvider;
exports.GetHistoryResponse = assistant.protoExports.GetHistoryResponse;
exports.InitialSettings = assistant.protoExports.InitialSettings;
exports.PacketWrapperFromServer = assistant.asrExports.PacketWrapperFromServer;
exports.createAnswerFromMockByMessageGetter = createAnswerFromMockByMessageGetter;
...
exports.createMockRecorder = createMockRecorder;
exports.createMockWSCreator = createMockWSCreator;

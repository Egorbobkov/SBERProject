...
var assistant = require('./assistant-f5cc74c7.js');
...
var createComponent = function (_a) {
    ...
    setState = function (modi) {
        ...
        state = assistant.__assign(assistant.__assign({}, (state || {})), nextState);
        if (lastProps) {
            update(lastProps);
        }
    };
...
var render = function (_a) {
    ...
    effect(function () { return setState(assistant.__assign({}, defaultState)); }, []);
    effect(function () {
        var offs = [];
        var handleStart = function () {
            recorder === null || recorder === void 0 ? void 0 : recorder.start();
            setState(assistant.__assign({}, defaultState));
        };
...
var createLogCallbackRecorder = function (defaultActive) {
    ...
    var _a = assistant.createBaseRecorder(defaultActive, getDefaultRecord), stop = _a.stop, start = _a.start, updateRecord = _a.updateRecord, getRecord = _a.getRecord, prepareHandler = _a.prepareHandler;
...
var initializeNativeSDKEmulator = function (_a) {
    ...
    var assistant$1 = assistant.createAssistant({
        url: url,
        userId: userId,
        ...
        settings: assistant.__assign(assistant.__assign({}, settings), { dubbing: settings.dubbing === false ? -1 : 1, echo: settings.echo || -1 }),
        fakeVps: fakeVps,
        version: vpsVersion,
        logger: logger,
        getMeta: getMeta,
    ...
    var fn = function () { return assistant.__awaiter(void 0, void 0, void 0, function () {
        var res, _i, _a, item;
        var _b, _c, _d, _e;
        return assistant.__generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, assistant$1.start({ initPhrase: initPhrase, disableGreetings: true })];
                case 1:
                    res = _f.sent();
                    if (initPhrase && res) {
                        if (((_b = res.app_info) === null || _b === void 0 ? void 0 : _b.frontendType) !== 'WEB_APP') {
                            alert('Ваш навык не зарегистрирован, или указаны ошибочные данные. Следуйте инструкции: https://github.com/salute-developers/salutejs-client#аутентификация');
                        }
                        ...
                        if (res === null || res === void 0 ? void 0 : res.feature_launcher) {
                        ...
                        for (_i = 0, _a = (res === null || res === void 0 ? void 0 : res.items) || []; _i < _a.length; _i++) {
                            ...
                            if (item.command != null && item.command.type === 'smart_app_data') {
                                initialSmartAppData.push(assistant.__assign(assistant.__assign({}, item.command), { sdk_meta: { mid: '-1' } }));
                            }
                        }
                        window.appInitialData = initialSmartAppData;
                        if (appInfo && appInfo.applicationId) {
                            assistant$1.setActiveApp(appInfo, function () { var _a, _b; return Promise.resolve((((_b = (_a = window.AssistantClient) === null || _a === void 0 ? void 0 : _a.onRequestState) === null || _b === void 0 ? void 0 : _b.call(_a)) || {})); });
    ...
    window.AssistantHost = {
                        ...
                        locations: [
                            {
                                ...
                                speed: (_b = coords.speed) === null || _b === void 0 ? void 0 : _b.toString(),
                                altitude: (_c = coords.altitude) === null || _c === void 0 ? void 0 : _c.toString(),
                            },
                        ],
                    },
                });
        ...
        sendData: function (payload, messageName) {
            ...
            return assistant.__awaiter(this, void 0, void 0, function () {
                return assistant.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, promise];
                        case 1:
                            _a.sent();
                            assistant$1.sendServerAction(JSON.parse(payload), messageName || undefined);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        sendDataContainer: function (container) {
            return assistant.__awaiter(this, void 0, void 0, function () {
                var _a, data, messageName, requestId, mode;
                return assistant.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, promise];
                        case 1:
                            _b.sent();
                            _a = JSON.parse(container), data = _a.data, messageName = _a.message_name, requestId = _a.requestId, mode = _a.mode;
                            assistant$1.sendServerAction(data, messageName || 'SERVER_ACTION', requestId, undefined, mode);
                            return [2 /*return*/];
                    }
                });
            });
    ...
    var subscribeToListenerStatus = function (cb) {
        return assistant$1.on('assistant', function (_a) {
    ...
    var subscribeToListenerHypotesis = function (cb) {
        return assistant$1.on('assistant', function (event) {
            if (event.asr) {
    ...
    var updateDevUI = function (params) {
        ...
        if (nativePanel) {
            var render = nativePanel.render, props = assistant.__rest(nativePanel, ["render"]);
            (render || renderNativePanel)(assistant.__assign(assistant.__assign(assistant.__assign({}, props), params), { sendText: sendText, sendServerAction: assistant$1.sendServerAction, onListen: assistant$1.listen, suggestions: suggestions, bubbleText: bubbleText, onSubscribeListenStatus: subscribeToListenerStatus, onSubscribeHypotesis: subscribeToListenerHypotesis }));
        }
    };
    var nativePanelApi = {
        hide: function () {
    ...
    assistant$1.on('app', function (event) {
        var _a;
        switch (event.type) {
            case 'close':
    ...
    assistant$1.on('command', function (command) {
        if (command.type === 'system' && command.system.command.toUpperCase() === 'BACK') {
            window.history.back();
        }
    });
    assistant$1.on('vps', function (event) {
        var _a, _b;
    ...
    assistant$1.on('tts', function (event) {
        emitOnData({
...
// eslint-disable-next-line no-useless-concat
var stand = 'wss://nlp2.devices.sb' + 'erb' + 'ank.ru/vps/';
var channelForSurface = {
    COMPANION: 'COMPANION_B2C',
    SBOL: 'SBOL',
};
var createAssistantDev = function (_a) {
    var getState = _a.getState, getRecoveryState = _a.getRecoveryState, ready = _a.ready, _b = _a.surface, surface = _b === void 0 ? 'SBERBOX' : _b, userChannel = _a.userChannel, sdkParams = assistant.__rest(_a, ["getState", "getRecoveryState", "ready", "surface", "userChannel"]);
    var nativePanel = initializeNativeSDKEmulator(assistant.__assign(assistant.__assign({}, sdkParams), { surface: surface, userChannel: userChannel || channelForSurface[surface] || 'B2C' })).nativePanel;
    return assistant.__assign(assistant.__assign({}, assistant.createAssistant$1({ getState: getState, getRecoveryState: getRecoveryState, ready: ready })), { nativePanel: nativePanel });
};
...
var createSmartappDebugger = function (_a) {
    var token = _a.token, getState = _a.getState, getRecoveryState = _a.getRecoveryState, ready = _a.ready, _b = _a.settings, settings = _b === void 0 ? {} : _b, nativePanel = _a.nativePanel, sdkParams = assistant.__rest(_a, ["token", "getState", "getRecoveryState", "ready", "settings", "nativePanel"]);
    try {
    ...
    return createAssistantDev(assistant.__assign(assistant.__assign({}, sdkParams), { token: token, settings: assistant.__assign(assistant.__assign({}, settings), { authConnector: 'developer_portal_jwt' }), nativePanel: nativePanel, getState: getState, getRecoveryState: getRecoveryState, ready: ready, url: stand }));
};
